...
| **Ollama（V1 推荐）** | 另需 **~6 GB+** | VLM `qwen2.5-vl:7b` 约 4.7 GB；Judge `qwen2.5:1.5b` 约 1 GB |
...
```bash
ollama list
# 应能看到 qwen2.5-vl:7b 与 qwen2.5:1.5b
```
...
| Ollama VLM + Agent LLM | ✅ | `qwen2.5-vl:7b` + `qwen2.5:1.5b`，规则降级 |
